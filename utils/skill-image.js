...
// Custom icons you should add in your assets/svg/skills folder
import seo from '../app/assets/svg/skills/seo.svg';
import marketing from '../app/assets/svg/skills/marketing.svg';
import contentwriting from '../app/assets/svg/skills/contentwriting.svg';
import ghostwriting from '../app/assets/svg/skills/ghostwriting.svg';
import speechwriting from '../app/assets/svg/skills/speechwriting.svg';
import ar from '../app/assets/svg/skills/ar.svg';
import ai from '../app/assets/svg/skills/ai.svg';
import branding from '../app/assets/svg/skills/branding.svg';
...
export const skillsImage = (skill) => {
  ...
  switch (skillID) {
    ...
    case 'sklearn': return scikitlearn;
    case '.net': return dotnet;
    case '.net core': return dotnetcore;
    ...
    case 'content strategy': return contentwriting;
    case 'ghostwriting': return ghostwriting;
    case 'speech writing': return speechwriting;
    case 'augmented reality': return ar;
    case 'artificial intelligence (ai)': return ai;
